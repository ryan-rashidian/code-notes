 ...
 *   Date: 2025-11-25
 *  Brief: Chapter 11 Project 4 - Modify poker.c
 */
...
void analyze_hand(int hand[NUM_CARDS][2],
                  bool *royal_flush, bool *straight, bool *flush,
                  bool *four, bool *three,
                  int *pairs);

void print_result(bool royal_flush, bool straight, bool flush,
                  bool four, bool three,
                  int pairs);
...
int main(void)
{
    ...
    for (;;) {
        read_cards(hand);
        sort_hand(hand);
        analyze_hand(hand, &royal_flush, &straight, &flush,
                     &four, &three, &pairs);
        print_result(royal_flush, straight, flush,
                     four, three, pairs);
    }
}
                  ...
                  int *pairs)
{
    ...
    *pairs = 0;
    ...
    // check for straigh with aces low
    if (!*straight)
        if (hand[0][0] == 0 &&
            hand[1][0] == 1 &&
            hand[2][0] == 2 &&
